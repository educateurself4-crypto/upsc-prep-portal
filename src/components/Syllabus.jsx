...
const Syllabus = () => {
    ...
    const syllabusData = {
        ...
        mains: [
            ...
            {
                id: 'm3',
                title: 'GS Paper III: Tech, Eco Dev, Bio-diversity, Env, Security & Disaster Mgmt',
                subTopics: [
    ...
    return (
        <div className="syllabus-container">
            <div className="section-header">
                <h2>Complete <span className="accent-text">UPSC Syllabus</span></h2>
                <div className="tabs">
                    <button
            ...
            <div className="syllabus-accordion">
                {syllabusData[activeTab].map((topic) => (
                    <div key={topic.id} className="accordion-item glass-card">
                        <div className="accordion-header" onClick={() => toggleTopic(topic.id)}>
                            <h3>{topic.title}</h3>
                            {expandedTopics[topic.id] ? <ChevronUp size={20} /> : <ChevronDown size={20} />}
                        </div>
                        <AnimatePresence>
                                ...
                                >
                                    <ul>
                                        {topic.subTopics.map((sub, idx) => (
                                            <li key={idx}>
                                                <Book size={14} className="accent-text" />
                                                <span>{sub}</span>
                                            </li>
                                        ))}
                                    </ul>
